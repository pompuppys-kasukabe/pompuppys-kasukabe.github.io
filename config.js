...
window.PUPPYS_CONFIG = {
  ...
  mediaTexts: {
    ...
    long400:
      "「勝つため」ではなく「踊ることを楽しむ」原点に立ち返り、チアダンスチーム「POM PUPPYS bright」（小6〜中3）の演技は劇変しました。埼玉・春日部を拠点に、世界最高峰の舞台、米国「The Dance Summit 2026」への挑戦を続けています。 直前の大会での悔しい結果は大きな試練でした。どん底の中、技術だけでなく表情や声、チームの雰囲気まで全てを見つめ直し、一丸となって立て直したのです。 本チームはふじみ野発祥のチームの流れを汲み、2016年に春日部で始動。2020年から大会挑戦を本格化し、苦節5年、ふじみ野の姉妹チームとの切磋琢磨で飛躍を遂げました。「原点回帰」でチアの楽しさを再発見した彼女たちは、最高の笑顔を春日部から世界へ届けようとしています。これは結果を超え、困難を乗り越える姿が人々に勇気を与える挑戦です。"
  },
